...
> **Current version:** v53 (testing) (see README.md's versioning convention — this repo's version is always
...
contents of `index.html`, `sw.js`, and `CARETRACKER_HANDOFF.md` with the literal 9-character text
